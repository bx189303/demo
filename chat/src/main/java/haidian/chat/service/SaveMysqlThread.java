...
public class SaveMysqlThread implements Runnable {
    ...
    public SaveMysqlThread(String msg, MessageMapper messageMapper, NotifyMapper notifyMapper, OnOffMapper onOffMapper) {
        this.msg = msg;
