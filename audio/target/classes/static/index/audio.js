...
function initHtmlPos(){
    $("#audioHtml").css('left',audioHtmlX);
    $("#audioHtml").css('top',audioHtmlY);
}
        ...
        success : function(result) {
            ...
            $(res).each(function(i,n){
                ...
                html+='<tr><td class="audioCheckBoxTd"><input type="checkbox" class="audioTdCheckBox" onclick=checkAllAduioBox()></td>\n' +
                    ...
                    '                    <td class="audioTd2" name="'+n.queueId+'"><div class="audioTd2 audioTdDiv" title="'+n.groupName+'">'+n.groupName+'</div></td>\n' +
...
function downloadAudio(obj){
    ...
    var called=dataTr.find(".audioTd2").text();
...
function downloadAudios(){
    ...
    $("tbody .audioTdCheckBox:checked").each(function(i,n){
        ...
        var called=tr.find(".audioTd2").text();
...
function windowHtmlMove(body,title){
    var div= document.getElementById("audioHtml");
    var divTitle=document.getElementById("audioWindowTitleName");
    var x = 0;
    var y = 0;
    var l = 0;
    var t = 0;
