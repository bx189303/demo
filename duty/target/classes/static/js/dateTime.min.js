(function (o) {
    ...
    var t, i = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], e = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
        n = new Date, p = n.getFullYear(), l = n.getMonth(), a = n.getDate(), u = n.getHours(), v = n.getMinutes(),
        s = null, r = {type: "date", background: "#494a4a"}, c = !1;
    o.extend(o.fn, {
        datetime: function (d) {
            return this.each(function () {
                ...
                t = o.extend(!0, {}, r, d), c || h(), o("#selcurday,#close,#dayDat,.changeMonth span,.selTime").unbind("click"), o("#yearSelect,#monthSelect").unbind("change"), o("#yearSelect,#monthSelect").change(function () {
                    ...
                    var t = o(this).parent();
                    t.animate({scrollTop: o(this).offset().top - t.offset().top + t.scrollTop() - o(this).outerHeight()}, 100)
                    ...
                    var n = S.offset().left, c = S.offset().top + S.outerHeight() + 4;
                    o(".dateTimeWrap").css({background: t.background, top: c, left: n})
                })
            }), this
        }
    })
